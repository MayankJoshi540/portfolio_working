        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
          ...
          <div className="flex-1 text-center lg:text-left space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <button className="px-8 py-3 border-2 border-slate-600 text-slate-300 font-semibold rounded-lg hover:border-emerald-400 hover:text-emerald-400 transition-all duration-300">
                Want Counselling??
              </button>
            </div>
          ...
          <div className="flex-shrink-0">
            <div className="relative">
              ...
              <div className="relative w-80 h-80 sm:w-96 sm:h-96 lg:w-[28rem] lg:h-[28rem] rounded-full overflow-hidden border-4 border-gradient-to-r from-emerald-400 to-cyan-400 shadow-2xl shadow-emerald-500/20">
                ...
                <div className="w-full h-full bg-gradient-to-br from-slate-700 to-slate-600 flex items-center justify-center">
                  ...
                  <div className="text-center space-y-4">
                    ...
                    <p className="text-slate-400 text-lg font-medium">Your Photo Here</p>
                  </div>
