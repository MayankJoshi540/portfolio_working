  ...
  const boards = [
    {
      ...
      icon: "📚",
      officialLink: "https://www.cbse.gov.in/cbsenew/question-paper.html",
      classes: [
        {
          class: "Class 10",
    ...
    },
    {
      ...
      icon: "🏔️",
      officialLinks: {
        "Class 12": "https://ubse.uk.gov.in/document-category/inter/",
        "Class 10": "https://ubse.uk.gov.in/document-category/high-school/"
      },
      classes: [
        {
          class: "Class 10",
  ...
  return (
    <section className="py-20 bg-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <div className="p-8 space-y-8">
                ...
                <div className="pt-6 border-t border-slate-600">
                  <a 
                    href={board.name === "CBSE Board" ? board.officialLink : "#"}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block w-full px-6 py-3 bg-gradient-to-r from-emerald-500 to-cyan-500 text-white font-semibold rounded-lg hover:from-emerald-600 hover:to-cyan-600 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-emerald-500/25 text-center"
                  >
                    Visit Official {board.name} Website
                  </a>
                  {board.name === "Uttarakhand Board" && (
                    <div className="mt-3 grid grid-cols-2 gap-3">
                      <a 
                        href={board.officialLinks["Class 10"]}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="px-4 py-2 bg-slate-700 text-slate-300 rounded-lg hover:bg-emerald-500 hover:text-white transition-all duration-300 text-center text-sm"
                      >
                        Class 10 Papers
                      </a>
                      <a 
                        href={board.officialLinks["Class 12"]}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="px-4 py-2 bg-slate-700 text-slate-300 rounded-lg hover:bg-emerald-500 hover:text-white transition-all duration-300 text-center text-sm"
                      >
        ...
        <div className="mt-16 p-8 bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 rounded-2xl border border-emerald-400/20">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="px-6 py-3 bg-emerald-500 text-white font-semibold rounded-lg hover:bg-emerald-600 transition-colors duration-300">
                Request Specific Papers
              </button>
              <Link
                href="/contact"
                className="px-6 py-3 border-2 border-emerald-400 text-emerald-400 font-semibold rounded-lg hover:bg-emerald-400 hover:text-slate-900 transition-all duration-300"
              >
                Contact Support
              </Link>
            </div>
